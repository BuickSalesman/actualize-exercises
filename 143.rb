...
# the mistake was trying to define the hash as if it were an array, putting [0] when that value does not exist within the hash yeilds no results. You must define where within the array you are searching in an example like this, in this case definine "dogs"