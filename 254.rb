...
class Person
  ...
  # puts "Bob's email is #{person.email}"
  # puts "Bob's hobbies are #{person.info}"
  ...
  class Product
    ...
    def initialize(options_hash) #the code is expecting to find 3 arguments here, and it only finds 1. You need to pass a single argument in the form of a hash - as insinuated by "options_hash"
